...
export type Locale = "de" | "en" | "tr" | "fr" | "ar";
...
const fr: TranslationKeys = {
  ...
  "player.retryAttempt": "Nouvelle tentative",
  "player.connectionReleasing": "Libération de la connexion",
  "player.loadingStream": "Chargement du flux...",
  "player.mediaError": "Correction de l'erreur média...",
  "player.altCodec": "Essai d'un codec alternatif...",
  "player.altFormat": "Essai d'un format alternatif...",
  "player.streamBlocked": "Flux bloqué (Erreur 456). Vérifiez votre abonnement.",
  "player.maxConnections": "Connexions maximales atteintes.",
  "player.maxConnectionsDesc": "Votre compte ne peut avoir qu'un nombre limité de flux simultanés.",
  "player.maxConnectionsHint": "Un autre appareil peut avoir un flux actif.",
  "player.maxConnectionsTips": "💡 Conseils: 1) Vérifier les autres appareils 2) Attendre et réessayer 3) Contacter le fournisseur IPTV",
  "player.loadFailed": "Impossible de charger le flux.",
  ...
  "live.searchChannels": "Rechercher des chaînes...",
  "live.favorites": "Favoris",
  "live.allChannels": "Toutes les chaînes",
  "live.countries": "Pays",
  "live.selectCategory": "Sélectionner une catégorie",
  "live.selectCategoryDesc": "Choisissez un pays et une catégorie pour charger les chaînes",
  "live.noChannels": "Aucune chaîne trouvée",
  "live.noFavorites": "Pas encore de favoris. Appuyez sur le cœur pour ajouter des chaînes!",
  "live.channels": "Chaînes",
  "live.loading": "Chargement TV en direct...",
  "live.loadingAll": "Chargement de toutes les chaînes...",

  "epg.title": "Guide TV",
  "epg.noFavorites": "Aucun favori. Ajoutez d'abord des chaînes aux favoris.",
  "epg.noChannels": "Aucune chaîne dans cette catégorie.",
  "epg.noEpg": "Aucune donnée EPG",
  "epg.watchNow": "Regarder maintenant",
  "epg.catchup": "Rattrapage",
  "epg.goToChannel": "Aller à la chaîne",
  "epg.noTitle": "Sans titre",
  "epg.channels": "Chaînes",

  "movies.title": "Films",
  "movies.play": "Lire",
  "movies.continue": "Continuer",
  "movies.continueFrom": "Continuer depuis",
  "movies.favorite": "Favori",
  "movies.trailer": "Bande-annonce",
  "movies.director": "Réalisateur",
  "movies.cast": "Distribution",
  "movies.originalTitle": "Titre original",
  "movies.showMore": "Afficher plus",
  "movies.showLess": "Moins",
  "movies.notFound": "Film introuvable",
  "movies.loading": "Chargement du film...",
  ...
  "series.play": "Lire",
  "series.continue": "Continuer",
  "series.noEpisodes": "Aucun épisode disponible.",
  "series.loading": "Chargement de la série...",
  "series.cast": "Distribution",
  "series.director": "Réalisateur",
  "series.asFavorite": "Ajouter aux favoris",
  "series.showMore": "Afficher plus",
  "series.showLess": "Afficher moins",

  "favorites.title": "Favoris",
  "favorites.saved": "enregistrés",
  "favorites.numberKeys": "Touches numériques pour changer",
  "favorites.all": "Tous",
  "favorites.noFavorites": "Pas encore de favoris",
  "favorites.noFavoritesDesc": "Ajoutez vos chaînes, films et séries préférés en appuyant sur l'icône cœur.",
  "favorites.channel": "Chaîne",

  "settings.title": "Paramètres",
  "settings.playlists": "Listes de lecture",
  "settings.newPlaylist": "Nouvelle liste",
  "settings.activePlaylist": "Liste active",
  "settings.savedPlaylists": "Listes enregistrées",
  "settings.edit": "Modifier",
  "settings.activate": "Activer",
  "settings.display": "Affichage & Contrôles",
  "settings.fontSize": "Taille de police",
  "settings.fontSizeDesc": "Augmenter pour une meilleure lisibilité",
  "settings.fontNormal": "Normal",
  "settings.fontLarge": "Grand",
  "settings.fontXL": "Très grand",
  "settings.remoteMode": "Mode télécommande",
  "settings.remoteModeDesc": "Boutons plus grands et commandes simplifiées",
  "settings.channelNumbers": "Afficher les numéros de chaînes",
  "settings.channelNumbersDesc": "Numéros sur les favoris pour un accès rapide",
  "settings.playerSection": "Lecteur",
  "settings.bufferSize": "Taille du tampon",
  "settings.bufferSizeDesc": "Plus élevé = moins d'interruptions de mise en mémoire",
  "settings.format": "Format",
  "settings.formatDesc": "Format de sortie du flux",
  "settings.autoplay": "Lecture automatique",
  "settings.autoplayDesc": "Lire automatiquement à l'ouverture",
  "settings.language": "Langue",
  "settings.languageDesc": "Changer la langue de l'application",
  "settings.parental": "Contrôle parental",
  "settings.pinLock": "Verrouillage PIN",
  "settings.pinSet": "PIN défini. Appuyez pour modifier.",
  "settings.pinNotSet": "Définir un PIN à 4 chiffres pour verrouiller le contenu",
  "settings.change": "Modifier",
  "settings.set": "Définir",
  "settings.data": "Données",
  "settings.clearHistory": "Effacer l'historique",
  "settings.clearHistoryDesc": "Supprimer tous les éléments récemment regardés",
  ...
  "settings.logoutDesc": "Vous devrez vous reconnecter.",
  "settings.cancel": "Annuler",
  "settings.save": "Enregistrer",
  "settings.deleteConfirm": "Effacer l'historique?",
  "settings.deleteDesc": "Toutes les entrées seront définitivement supprimées.",
  "settings.name": "Nom",
  "settings.serverUrl": "URL du serveur",
  "settings.username": "Nom d'utilisateur",
  "settings.password": "Mot de passe",
  "settings.xtreamCodes": "Xtream Codes",
  "settings.m3uUrl": "URL M3U",
  "settings.addAndActivate": "Ajouter et activer",

  "search.placeholder": "Rechercher chaînes, films, séries...",
  ...
  "common.min": "min",
  "common.hour": "h",
  "common.pressAgainToExit": "Appuyez à nouveau pour quitter",
};
...
const ar: TranslationKeys = {
  ...
  "player.retryAttempt": "محاولة جديدة",
  "player.connectionReleasing": "تحرير الاتصال",
  "player.loadingStream": "جارٍ تحميل البث...",
  "player.mediaError": "إصلاح خطأ الوسائط...",
  "player.altCodec": "تجربة ترميز بديل...",
  "player.altFormat": "تجربة تنسيق بديل...",
  "player.streamBlocked": "البث محظور (خطأ 456). تحقق من اشتراكك.",
  "player.maxConnections": "تم الوصول إلى الحد الأقصى للاتصالات.",
  "player.maxConnectionsDesc": "يمكن لحسابك فقط عدد محدود من التدفقات المتزامنة.",
  "player.maxConnectionsHint": "قد يكون هناك بث نشط على جهاز آخر.",
  "player.maxConnectionsTips": "💡 نصائح: 1) تحقق من الأجهزة الأخرى 2) انتظر وأعد المحاولة 3) اتصل بمزود IPTV",
  "player.loadFailed": "تعذر تحميل البث.",
  "player.tryAgain": "إعادة المحاولة",
  "player.back": "رجوع",
  "player.live": "مباشر",
  ...
  "live.title": "بث مباشر",
  "live.searchChannels": "البحث عن القنوات...",
  "live.favorites": "المفضلة",
  "live.allChannels": "جميع القنوات",
  "live.countries": "الدول",
  "live.selectCategory": "اختر فئة",
  "live.selectCategoryDesc": "اختر دولة وفئة لتحميل القنوات",
  "live.noChannels": "لم يتم العثور على قنوات",
  "live.noFavorites": "لا توجد مفضلة بعد. اضغط على القلب لإضافة القنوات!",
  "live.channels": "قنوات",
  "live.loading": "جارٍ تحميل البث المباشر...",
  "live.loadingAll": "جارٍ تحميل جميع القنوات...",

  "epg.title": "دليل التلفزيون",
  "epg.noFavorites": "لا توجد مفضلة. أضف القنوات كمفضلة أولاً.",
  "epg.noChannels": "لا توجد قنوات في هذه الفئة.",
  "epg.noEpg": "لا توجد بيانات EPG",
  "epg.watchNow": "شاهد الآن",
  "epg.catchup": "المشاهدة اللاحقة",
  "epg.goToChannel": "الانتقال إلى القناة",
  "epg.noTitle": "بلا عنوان",
  "epg.channels": "القنوات",

  "movies.title": "الأفلام",
  "movies.play": "تشغيل",
  "movies.continue": "متابعة",
  "movies.continueFrom": "متابعة من",
  "movies.favorite": "مفضلة",
  "movies.trailer": "إعلان",
  "movies.director": "المخرج",
  "movies.cast": "طاقم التمثيل",
  "movies.originalTitle": "العنوان الأصلي",
  "movies.showMore": "عرض المزيد",
  "movies.showLess": "أقل",
  "movies.notFound": "الفيلم غير موجود",
  "movies.loading": "جارٍ تحميل الفيلم...",
  ...
  "series.episode": "حلقة",
  "series.play": "تشغيل",
  "series.continue": "متابعة",
  "series.noEpisodes": "لا توجد حلقات متاحة.",
  "series.loading": "جارٍ تحميل المسلسل...",
  "series.cast": "طاقم التمثيل",
  "series.director": "المخرج",
  "series.asFavorite": "إضافة إلى المفضلة",
  "series.showMore": "عرض المزيد",
  "series.showLess": "عرض أقل",

  "favorites.title": "المفضلة",
  "favorites.saved": "محفوظ",
  "favorites.numberKeys": "المفاتيح الرقمية للتبديل",
  "favorites.all": "الكل",
  "favorites.noFavorites": "لا توجد مفضلة بعد",
  "favorites.noFavoritesDesc": "أضف قنواتك وأفلامك ومسلسلاتك المفضلة بالضغط على أيقونة القلب.",
  "favorites.channel": "قناة",

  "settings.title": "الإعدادات",
  "settings.playlists": "قوائم التشغيل",
  "settings.newPlaylist": "قائمة جديدة",
  "settings.activePlaylist": "القائمة النشطة",
  "settings.savedPlaylists": "القوائم المحفوظة",
  "settings.edit": "تعديل",
  "settings.activate": "تفعيل",
  "settings.display": "العرض والتحكم",
  "settings.fontSize": "حجم الخط",
  "settings.fontSizeDesc": "كبّر لقراءة أفضل",
  "settings.fontNormal": "عادي",
  "settings.fontLarge": "كبير",
  "settings.fontXL": "كبير جداً",
  "settings.remoteMode": "وضع التحكم عن بعد",
  "settings.remoteModeDesc": "أزرار أكبر وتحكم أبسط",
  "settings.channelNumbers": "عرض أرقام القنوات",
  "settings.channelNumbersDesc": "أرقام على المفضلة للوصول السريع",
  "settings.playerSection": "المشغّل",
  "settings.bufferSize": "حجم المخزن المؤقت",
  "settings.bufferSizeDesc": "أعلى = انقطاعات أقل",
  "settings.format": "التنسيق",
  "settings.formatDesc": "تنسيق إخراج البث",
  "settings.autoplay": "التشغيل التلقائي",
  "settings.autoplayDesc": "التشغيل تلقائياً عند الفتح",
  "settings.language": "اللغة",
  "settings.languageDesc": "تغيير لغة التطبيق",
  "settings.parental": "الرقابة الأبوية",
  "settings.pinLock": "قفل PIN",
  "settings.pinSet": "تم تعيين PIN. اضغط للتغيير.",
  "settings.pinNotSet": "تعيين PIN مكون من 4 أرقام لقفل المحتوى",
  "settings.change": "تغيير",
  "settings.set": "تعيين",
  "settings.data": "البيانات",
  "settings.clearHistory": "مسح السجل",
  "settings.clearHistoryDesc": "إزالة جميع الإدخالات المشاهدة مؤخراً",
  "settings.delete": "حذف",
  "settings.device": "الجهاز",
  "settings.macAddress": "عنوان MAC",
  "settings.appVersion": "إصدار التطبيق",
  "settings.logout": "تسجيل الخروج",
  "settings.logoutConfirm": "تسجيل الخروج؟",
  "settings.logoutDesc": "ستحتاج إلى تسجيل الدخول مرة أخرى.",
  "settings.cancel": "إلغاء",
  "settings.save": "حفظ",
  "settings.deleteConfirm": "مسح السجل؟",
  "settings.deleteDesc": "سيتم حذف جميع الإدخالات نهائياً.",
  "settings.name": "الاسم",
  "settings.serverUrl": "رابط الخادم",
  "settings.username": "اسم المستخدم",
  "settings.password": "كلمة المرور",
  "settings.xtreamCodes": "Xtream Codes",
  "settings.m3uUrl": "رابط M3U",
  "settings.addAndActivate": "إضافة وتفعيل",

  "search.placeholder": "البحث عن قنوات وأفلام ومسلسلات...",
  ...
  "common.min": "د",
  "common.hour": "س",
  "common.pressAgainToExit": "اضغط مرة أخرى للخروج",
};

export const translations: Record<Locale, TranslationKeys> = { de, en, tr, fr, ar };
